...
Timestamp: 2026-07-30T08:46:50.412554+00:00
...
--- Priorities ---
1. **Active Workflows:** 3× `sales/prospect-research` (all at step 0, batch-processed).
2. **Completed Work:** 2× `development/code-review`, 1× `marketing/content-production`, 2× `sales/prospect-research`.
3. **Department Utilization:**
4. **Sales:** 3 agents active (100% utilization).
5. **Marketing:** 1 active workflow (33% utilization).
...
Top priority: **Active Workflows:** 3× `sales/prospect-research` (all at step 0, batch-processed).