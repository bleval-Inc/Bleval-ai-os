...
Timestamp: 2026-07-30T01:48:27.598863+00:00
...
--- Priorities ---
1. **Active Workflows:** 3 total
2. 2× `sales/prospect-research` (running, step 0)
3. 1× `marketing/market-research` (running, step 0)
4. **Completed This Cycle:** 5
5. 3× `sales/prospect-research`
...
Top priority: **Active Workflows:** 3 total