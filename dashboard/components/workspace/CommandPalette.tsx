...
export default function CommandPalette() {
  ...
  const navCommands: Command[] = useMemo(
    () => [
      ...
      { id: "goto-settings", label: "Go to Settings", description: "Configuration & preferences (inside SYSTEM)", category: "Navigation", shortcut: "⌘,", keywords: ["settings", "config", "system"], action: () => { setActiveView("system"); setActiveWorkstation("system"); setCommandPalette(false); } },
